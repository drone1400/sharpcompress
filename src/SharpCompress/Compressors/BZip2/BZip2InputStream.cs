...
namespace SharpCompress.Compressors.BZip2
{
	...
	public class BZip2InputStream : Stream
	{
        ...
        public static bool IsBZip2(Stream inputStream)
        {
            BZip2BitInputStream bitStream = new BZip2BitInputStream(inputStream);
            uint marker1 = bitStream.ReadBits(16);

            // rewind the 2 read bytes...
            if (inputStream.CanSeek)
            {
                inputStream.Position -= 2;
            }

            return marker1 == BZip2OutputStream.STREAM_START_MARKER_1;
        }

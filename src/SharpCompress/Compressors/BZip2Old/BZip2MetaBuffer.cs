...
namespace SharpCompress.Compressors.BZip2Old
{
    ...
    internal class BZip2BitMetaBuffer : IBzip2BitOutputStream
    {
        private struct Bzip2BitDataPair
        {
            ...
            public int BitV { get; }
            public Bzip2BitDataPair(byte bitN, int bitV)
            {
                this.BitN = bitN;
                this.BitV = bitV;
            }
        ...
        public void CompressBytes() {
            ...
            this._blockCrc = (uint)this._compressor.BlockCrc;
        ...
        {
            this._data.Add(new Bzip2BitDataPair(1, value ? (int)1 : (int)0));
        }
        ...
        {
            this._data.Add(new Bzip2BitDataPair((byte)1, isOne ? 1 : 0));
        }

        public void WriteByte(byte value)
        {
            this._data.Add(new Bzip2BitDataPair(8, value));
        }
